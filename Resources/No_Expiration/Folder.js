...
class CreateFolderTests extends Common {
    constructor() {
        super();
        ...
        try {
            ...
            if (testCase.bucket.permissions.list) {
                ...
                try {
                    ...
                    const foundInListing = objects.some(obj => obj.Key === prefix);
        ...
        try {
            ...
            try {
                ...
                if (msg.includes('access denied') || msg.includes('permission')) {
                    ...
                    return true; // treat as skipped/pass for infra-caused failure
                } else {
                    throw error;
                }
            }
...
export default CreateFolderTests;
